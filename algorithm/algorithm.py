...
from algorithm.config import ALG
from algorithm.utils import IterationData, TrajectoryInfo
from utility.general_utils import extract_condition
...
class Algorithm(object):
    ...
    def __init__(self, hyperparams):
        ...
        # create traj_opt_lqr_python object
